                    ...
                    <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
                        ...
                        <div class="card" id="form-style">
                            ...
                            <form enctype="multipart/form-data" class="form-card" id="product-form"
                                action="<?php echo e(route('product.storeProduct')); ?>"
                                  method="post">
                                <?php echo csrf_field(); ?>
        ...
        //     if (status === true) {
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            window.location = '<?php echo e(route('product.indexs')); ?>';
                        } else {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Projects\HospitalManagement\resources\views/payment/addProduct.blade.php ENDPATH**/ ?>